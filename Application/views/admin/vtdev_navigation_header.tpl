...
<form name="vtdevutils" id="vtdevutils" action="[{$oViewConf->getSelfLink() }]" method="post" target="vtdevframe" style="float:left; margin: -10px 10px 0 -20px;">
    [{$oViewConf->getHiddenSid() }]
    <input type="hidden" name="cl" value="DevGui">
    <input type="checkbox" id="keepalive" name="fnc" value="keepalive">
    <button class="btn-vtdev"><label for="keepalive">keep me<br/>logged in</label></button>

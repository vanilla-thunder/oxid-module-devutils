...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="[{$oViewConf->getModuleUrl("dev-core","out/libs/lumx/dist/lumx.css")}]"/>
    [{* <link rel="stylesheet" type="text/css" href="[{$oViewConf->getModuleUrl("dev-core","src/fontawesome/css/font-awesome.min.css")}]"/> *}]

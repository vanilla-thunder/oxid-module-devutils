...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="[{$oViewConf->getModuleUrl("_dev-core","src/lumx/dist/lumx.css")}]"/>
    [{* <link rel="stylesheet" type="text/css" href="[{$oViewConf->getModuleUrl("_dev-core","src/fontawesome/css/font-awesome.min.css")}]"/> *}]
    <link rel="stylesheet" type="text/css" href="[{$oViewConf->getModuleUrl("_dev-core","src/mdi/css/materialdesignicons.min.css")}]"/>
...
<body ng-app="devApp" ng-controller="devCtrl">
    [{capture name=appdep}]'lumx'[{/capture}]
